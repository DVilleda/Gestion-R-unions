<%-- 
    ...
    Created on : May 14, 2020, 3:54:01 p.m.
    ...
    <body>
        ...
        <c:if test="${empty sessionScope.username}"> 
            <form:form method="post" modelAttribute="form">
                <form:label path="username">Entrer l'usager que vous voulez créer</form:label>
                <form:input path="username" /><br>
                <form:label path="password">Entrer un mot de passe</form:label>
